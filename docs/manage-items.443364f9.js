...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"ts/manage-items.ts":[function(require,module,exports) {
"use strict";
...
function loadAllItems() {
  (0, axios_1.default)(ITEMS_SERVICE_API + "?" + new URLSearchParams({
    page: PAGINATION.selectedPage + "",
    size: PAGE_SIZE + ""
  })).then(function (response) {
    if (response.status !== 200) throw new Error("Failed to load items, try again");
...
function deleteItem(code) {
  (0, axios_1.default)({
    method: "DELETE",
    url: ITEMS_SERVICE_API + ("?" + new URLSearchParams({
      code: code
    }))
  }).then(function (response) {
...
},{"./dto/item":"ts/dto/item.ts","jquery":"node_modules/jquery/dist/jquery.js","./pagination":"ts/pagination.ts","big.js":"node_modules/big.js/big.js","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
