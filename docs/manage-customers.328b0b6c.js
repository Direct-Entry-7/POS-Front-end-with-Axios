...
function loadAllCustomers() {
  (0, axios_1.default)(CUSTOMERS_SERVICE_API + "?" + new URLSearchParams({
...
function deleteCustomer(id) {
  (0, axios_1.default)({
    method: "DELETE",
    url: CUSTOMERS_SERVICE_API + ("?" + new URLSearchParams({
      id: id
    }))
  }).then(function (response) {
...
},{"./dto/customer":"ts/dto/customer.ts","jquery":"node_modules/jquery/dist/jquery.js","./pagination":"ts/pagination.ts","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
